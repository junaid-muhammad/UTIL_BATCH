...
if [[ "${HOSTNAME}" = *"farm"* ]]; then  
    ...
    REPLAYPATH="/group/c-pionlt/USERS/${USER}/hallc_replay_lt"
    UTILPATH="/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_PION/"
    #source /site/12gev_phys/softenv.sh 2.4
    source /apps/root/6.18.04/setroot_CUE.bash
    cd "/group/c-pionlt/hcana/"
    source "/group/c-pionlt/hcana/setup.sh" 
...
eval "$REPLAYPATH/hcana -l -q \"UTIL_PION/scripts/replay/PionLT/FullReplay_PionLT.C($RUNNUMBER,$MAXEVENTS)\""
exit 0
