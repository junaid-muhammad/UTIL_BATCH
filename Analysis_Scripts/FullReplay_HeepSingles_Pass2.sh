...
### 27/05/21
### The analysis script used to process the Pass2 full replay for Heep singles AND lumi data
...
eval "$REPLAYPATH/hcana -l -q \"SCRIPTS/COIN/PRODUCTION/FullReplay_HeepSingles_Pass2.C($RUNNUMBER,$MAXEVENTS)\""
exit 0
