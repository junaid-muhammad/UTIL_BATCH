...
### 18/05/21
### The batch script used to process the Pass2 Heep Singles and lumi data
...
while true; do
    ...
    case $yn in
		...
		echo "COMMAND:/group/c-pionlt/online_analysis/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/FullReplay_HeepSingles_Pass2.sh ${runNum} ${MAXEVENTS}" >> ${batch}
