...
while true; do
    ...
    case $yn in
		...
		batch="${USER}_${runNum}_HeePSing_FullReplay.txt"
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-pionlt/online_analysis/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/FullReplay_HeepSingles_Pass1.sh ${runNum}" >> ${batch}
