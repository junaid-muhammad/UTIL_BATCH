...
##Input run numbers##                                                                                                                                                                                             
inputFile="/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/InputRunLists/ProductionLH2_ALL"
## Tape stub                                                                                                                                                                                                      
...
while true; do
    ...
    case $yn in
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/Full_KaonLT_Batch.sh ${runNum}" >> ${batch}                                                        
