...
while true; do
    ...
    case $yn in
		...
		batch="${USER}_${runNum}_FullReplay_Lumi_Job.txt"
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-pionlt/online_analysis/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/FullReplay_Lumi_Pass2.sh ${runNum}" >> ${batch}
