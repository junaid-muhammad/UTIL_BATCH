...
while true; do
    ...
    case $yn in
		...
		batch="${USER}_${runNum}_FullReplay_100k_Job.txt"
		...
		echo "COMMAND:/group/c-pionlt/online_analysis/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/FullReplay_Pass1_100k.sh ${runNum}" >> ${batch}
